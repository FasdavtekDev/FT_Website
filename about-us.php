						...
						<div class="row py-5 mb-5 mt-2 p-relative z-index-1">
							<div class="col">
								...
								<div class="overflow-hidden mb-4">
									<h1 class="d-block text-color-quaternary font-weight-bold text-center mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1000">About Us</h1>

								</div>
								<p class="text-justify">Fasdavtek is a leading Information Technology (IT) solution provider. We focus on consultative and business requirements in the IT Services we offer. We strategically enhance our clients' businesses with the right IT solutions through diverse expertise and a deep understanding of the client's vision and requirements.
									Our core capabilities include Infrastructure and IT Consulting, software development and support.</p>

								<div class="overflow-hidden mb-4">
									<h1 class="d-block text-color-quaternary font-weight-bold text-center mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1000">Our Mission</h1>

								</div>
								<p class="text-justify">
									To provide effective IT solutions to solve complex IT problems for businesses.
									We work towards being more than just an average IT solution company by reaching beyond limits to deliver an exceptional service.
								</p>

								<div class="overflow-hidden mb-4">
									<h1 class="d-block text-color-quaternary font-weight-bold text-center mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1000">Our Vision</h1>

								</div>
								<p class="text-justify">
									Reaching Beyond Limits to provide effective IT Services at your easiest reach.
								</p>
							</div>
						</div>
					</div>
