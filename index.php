...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-196770685-1">
</script>
<script>
  ...
  gtag('config', 'UA-196770685-1');
</script>
		<meta name="keywords" content="FasDavTek Limited" />
		<meta name="description" content="Reaching beyond limits...">
		<meta name="author" content="fasdavtek.com">
		...
		<link id="googleFonts" href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,700%7CPlayfair+Display:400,700,900&display=swap" rel="stylesheet" type="text/css">
		...
		<!-- Demo CSS -->		<link rel="stylesheet" href="css/demos/demo-startup-agency.css">		<!-- Skin CSS -->		<link id="skinCSS" rel="stylesheet" href="css/skins/skin-startup-agency.css">
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div class="custom-section-svg pt-5 pb-5 pb-md-0 mb-5 mb-md-0"m>
						...
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							...
							<linearGradient id="gradient_SVG_1_" class="custom-svg-linear-gradient" gradientUnits="userSpaceOnUse" x1="1608.6167" y1="668.754" x2="1197.4358" y2="257.5732">
								<stop  offset="3.745963e-03" style="stop-color:#fd6800"/>
								<stop  offset="1" style="stop-color:#e7955a"/>
							</linearGradient>
							...
							<linearGradient id="gradient_SVG_2_" class="custom-svg-linear-gradient" gradientUnits="userSpaceOnUse" x1="1621.6152" y1="666.8627" x2="1207.4606" y2="252.708">
								<stop  offset="3.745963e-03" style="stop-color:#f1761e"/>
								<stop  offset="1" style="stop-color:#e7955a"/>
							</linearGradient>
							...
							<g class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1500" data-appear-animation-duration="2s">
								<circle fill="#e7955a" cx="128.5" cy="446" r="11.5"/>
								...
								<g data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
									<circle class="" style="background-color: #e7955a;" fill="#e7955a" cx="1051" cy="367.5" r="33"/>
								...
								<g data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.3, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
									<circle class="" style="background-color: #e7955a;" fill="#e7955a" cx="1615" cy="734.5" r="17"/>
									<circle fill="#EFF1F3" cx="1615.31" cy="734.81" r="15.43"/>
								</g>
								<circle fill="#e7955a" cx="635.5" cy="519" r="6.5" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}" />
								
								<circle fill="#e7955a" cx="647.5" cy="183" r="10.5" data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}"/>
								
								<g data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
									<circle class="" style="background-color: #e7955a;" fill="#e7955a" cx="1638" cy="163.5" r="23"/>
							...
							<g class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1800" data-appear-animation-duration="2s">
								<g data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.2, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
									<circle class="custom-svg-fill-color-secondary" fill="#e7955a" cx="264" cy="303.5" r="27"/>
								...
								<g data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
									<circle class="custom-svg-fill-color-primary" fill="#e7955a" cx="857" cy="644.5" r="17"/>
				...
				<div class="custom-circle custom-circle-medium custom-circle-pos-2 appear-animation" data-appear-animation="expandInWithBlur" data-appear-animation-delay="1450" data-appear-animation-duration="2s">
					<div class="rounded-circle w-100 h-100" style="background-color: #e7955a;" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.2, 'transition': true, 'transitionDuration': 2000}"></div>
				</div>
				<div class="custom-circle custom-circle-medium custom-circle-pos-3 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="1300">
					<div class="custom-bg-color-grey-2 rounded-circle w-100 h-100" style="background-color:#e7955a ;" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000}"></div>
				</div>
				...
				<div class="custom-circle custom-circle-medium custom-circle-pos-5 appear-animation" data-appear-animation="expandInWithBlur" data-appear-animation-delay="1050" data-appear-animation-duration="2s">
					<div class="rounded-circle w-100 h-100" style="background-color: #e7955a;" data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 2000}"></div>
				</div>
					...
					<div class="container position-relative z-index-1 pt-5 mt-5">
						...
						<div class="row align-items-center pt-4">
							<div class="col-md-6 pb-5 mb-md-5">
								...
								<h1 class="text-color-dark font-weight-bold text-9 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">Your Business Needs Our Software SOLUTIONS!</h1>
								<p class="custom-text-color-grey-1 text-4 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="450">We deliver enterprise solutions, outsourcing and Consultancy services to global businesses, with 99% project delivery success. Our design-focused approach and project execution processes help you to deliver the right solutions.

									</p>
								<a href="#" class="btn btn-gradient btn-rounded font-weight-semibold px-5 py-3 text-3 mb-md-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">What we do</a>
				...
				<section class="section position-relative bg-color-light border-0 m-0">
					...
					<div class="container position-relative custom-negative-margin-1 z-index-3 pb-lg-5 mb-lg-3">
						...
						<div class="custom-circle custom-circle-big custom-circle-pos-10 appear-animation" data-appear-animation="expandInWithBlur" data-appear-animation-delay="1850" data-appear-animation-duration="2s">
							<div class="rounded-circle w-100 h-100" style="background-color: #f5c29d;" data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 3, 'transition': true, 'transitionDuration': 1000}"></div>
						</div>
				...
				<section class="section bg-color-light position-relative border-0 pt-0 m-0">
					...
					<div class="container position-relative z-index-1">
						<div class="custom-circle custom-circle-medium custom-circle-pos-17 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="200">
							<div class="rounded-circle w-100 h-100" style="background-color: #e7955a;"  data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.5, 'transition': true, 'transitionDuration': 2000}"></div>	
						</div>
							...
							<div class="col-8 text-center">
								<div class="row p-relative z-index-1">	
									...
									<div class="col-lg-7">
										...
										<h5 class="text-justify text-uppercase">◉ Web Applications and Services </h5>
										<h5 class="text-justify text-uppercase">◉ Interactive Voice Response (IVR) development</h5>
					...
					<div class="container position-relative pb-lg-5">
						<div class="custom-dots-rect-4" style="background-image: url(img/demos/seo-2/dots-group.png);"></div>
						<div class="row py-5 mt-5 mb-lg-3">
							<div class="col-lg-6 mb-5 mb-lg-0">
								<div class="custom-circles-group-1 counters pr-5 mr-5">
									...
									<div class="circle-3" style="background-color: #e7955a;">
										<div class="counter">
											<strong class="text-color-light text-10 line-height-1" data-to="10" data-append="+">0</strong>
											<label class="text-color-light text-4">Team Members</label>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-6">
								...
								<div class="progress-bars custom-progress-bars-style-1 mt-4">
									...
									<div class="progress-label">
										<span class="d-block text-3 mb-1">Project Completion</span>
									</div>
									<div class="progress mb-3">
										<span class="progress-bar-tooltip">100%</span>
										<div class="progress-bar progress-bar-quaternary" data-appear-progress-animation="100%" data-appear-animation-delay="600"></div>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="owl-carousel custom-carousel-style-1 custom-carousel-dots-style-1" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '979': {'items': 2}, '1199': {'items': 2}}, 'margin': 0, 'loop': true, 'dots': true, 'nav': false, 'autoplay': true}">
									<div>
										<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
											<blockquote>
												<p class="mb-0">The Central Bank of Nigeria is the central bank and apex monetary authority of Nigeria established by the CBN Act of 1958 and commenced operations on July 1, 1959. </p>
											</blockquote>
											<div class="testimonial-author">
												<div class="testimonial-author-thumbnail">
													<img src="img/clients/cbn.png" class="img-fluid rounded-circle" alt="">
												</div>
												<p><strong class="font-weight-semibold text-4 mb-1">CBN</strong><span class="text-2">CENTRAL BANK OF NIGERIA</span></p>
											</div>
										</div>
									</div>
									<div>
										<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
											<blockquote>
												<p class="mb-0">The National Youth Service Corps is a program set up by the Nigerian government to involve Nigerian graduates in nation building and the development of the country.</p>
											</blockquote>
											<div class="testimonial-author">
												<div class="testimonial-author-thumbnail">
													<img src="img/clients/nysc.jpeg" class="img-fluid rounded-circle" alt="">
												</div>
												<p><strong class="font-weight-semibold text-4 mb-1">NYSC</strong><span class="text-2">NATIONAL YOUTH SERVICE CORP</span></p>
											</div>
										</div>
									</div>
									<div>
									...
									<div>
										<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
											...
											<div class="testimonial-author">
												<div class="testimonial-author-thumbnail">
													<img src="img/clients/dragnet.png" class="img-fluid rounded-circle" alt="">
												</div>
												<p><strong class="font-weight-semibold text-4 mb-1">DRAGNET</strong><span class="text-2">DRAGNET</span></p>
											</div>
										</div>
									</div>
									<div>
										<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
											...
											<div class="testimonial-author">
												<div class="testimonial-author-thumbnail">
													<img src="img/clients/access-bank.jpeg" class="img-fluid rounded-circle" alt="">
												</div>
												<p><strong class="font-weight-semibold text-4 mb-1">ACESS BANK</strong><span class="text-2">ACCESS BANK</span></p>
											</div>
										</div>
									</div>
									<div>
										<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
											...
											<div class="testimonial-author">
												<div class="testimonial-author-thumbnail">
													<img src="img/clients/sigma.jpeg" class="img-fluid rounded-circle" alt="">
												</div>
												<p><strong class="font-weight-semibold text-4 mb-1">Sigma Pensions</strong><span class="text-2">Sigma Pensions</span></p>
											</div>
										</div>
									</div>
									<div>
										<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
											...
											<div class="testimonial-author">
												<div class="testimonial-author-thumbnail">
													<img src="img/clients/keril.jpeg" class="img-fluid rounded-circle" alt="">
												</div>
												<p><strong class="font-weight-semibold text-4 mb-1">Kerildbert</strong><span class="text-2">Kerildbert</span></p>
											</div>
										</div>
									</div>
									<div>
										<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
											<blockquote>
												<p class="mb-0">Gr8Jobsng is a top recruitment platform in Nigeria. Offering HR services that bridge the gap between employers and job seekers. </p>
											</blockquote>
											<div class="testimonial-author">
												<div class="testimonial-author-thumbnail">
													<img src="img/clients/gr8.jpeg" class="img-fluid rounded-circle" alt="">
												</div>
												<p><strong class="font-weight-semibold text-4 mb-1">Gr8jobs Nigeria</strong><span class="text-2">Gr8jobs Nigeria</span></p>
											</div>
										</div>
									</div>
								</div>
					...
					<svg class="custom-section-curved-top-4" width="100%" height="298" xmlns="http://www.w3.org/2000/svg">
						<path id="svg_2" fill="#fff" stroke="#000" stroke-width="0" d="m-16.68437,95.44889c0,0 5.33335,176.00075 660.00283,93.33373c327.33474,-41.33351 503.33549,15.3334 639.00274,35.66682c135.66725,20.33342 59.66691,9.66671 358.33487,28.33346c298.66795,18.66676 268.66829,-45.00088 382.66831,-112.00048c114.00002,-66.9996 718.31698,-59.48704 1221.66946,95.563c503.35248,155.05004 -221.83202,184.10564 -243.66935,197.60521c-21.83733,13.49958 -3008.67549,-19.83371 -3008.00467,-20.83335c-0.67082,0.99964 -30.00428,-232.33469 -10.00419,-317.66839z"  class="svg-fill-color-secondary"/>
					</svg>
