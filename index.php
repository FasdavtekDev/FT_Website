	...
	<body data-target="#header" data-spy="scroll" data-offset="100">
		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="custom-circle custom-circle-wrapper custom-circle-big custom-circle-pos-9 appear-animation" data-appear-animation="expandInWithBlur" data-appear-animation-delay="900" data-appear-animation-duration="2s">
					...
					<div class="container position-relative custom-negative-margin-1 z-index-3 pb-lg-5 mb-lg-3">
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-5 pt-lg-5 pl-lg-4 mt-lg-5">
								...
								<p class="mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750"> A successful offshore software application development company since 1997, providing a full range of website and mobile app development, games development, IoT, AR-VR and other IT services and solutions globally..</p>
				...
				<section class="section custom-bg-color-light-2 position-relative border-0 pt-4 m-0">
					...
					<div class="container position-relative z-index-1 mt-3 mb-5">
						<div class="custom-circle custom-circle-small custom-circle-pos-14">
							<div class=" rounded-circle w-100 h-100" style="background-color: #e7955a;" data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 1, 'horizontal': true, 'transition': true, 'transitionDuration': 1000}"></div>
						</div>
						...
						<div class="row text-center align-items-center pb-4 pt-lg-4 mb-3 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
							<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
								<img src="img/logos/logo-8.png" class="img-fluid" alt="" style="max-width: 90px;" />
							</div>
							<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
								<img src="img/logos/logo-9.png" class="img-fluid" alt="" style="max-width: 130px;" />
							</div>
							<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
								<img src="img/logos/logo-10.png" class="img-fluid" alt="" style="max-width: 130px;" />
							</div>
							<div class="col-md-4 col-lg-2 mb-4 mb-md-0">
								<img src="img/logos/logo-11.png" class="img-fluid" alt="" style="max-width: 130px;" />
							</div>
							<div class="col-md-4 col-lg-2 mb-4 mb-md-0">
								<img src="img/logos/logo-12.png" class="img-fluid" alt="" style="max-width: 120px;" />
							</div>
							<div class="col-md-4 col-lg-2">
								<img src="img/logos/logo-13.png" class="img-fluid" alt="" style="max-width: 130px;" />
							</div>
						</div>
						...
						<div class="row mobile-hide">
							<div class="col-lg-6 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="450">
								...
								<p class="lead pr-5 mb-4 pb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur.</p>
								<div class="feature-box">
									...
									<div class="feature-box-info mb-4 pb-3">
										<h4 class="font-weight-bold line-height-3 custom-font-size-1 mb-1">Content Writing and Organization</h4>
								...
								<div class="feature-box">
									...
									<div class="feature-box-info">
										<h4 class="font-weight-bold line-height-3 custom-font-size-1 mb-1">Site Map Improvements and Directions</h4>
										<p class="mb-0">Consectetur adipiscing elit. Sed imperdiet libero id nisi euismod sed porta est consectetur.</p>
									</div>
								</div>
							</div>
						...
						<div class="row justify-content-center mb-4">
							<div class="col-8 text-center">
								...
								<div class="overflow-hidden mb-2">
									<h2 class="font-weight-bold text-7 mb-0 appear-animation" style="color: #2c2c30;" data-appear-animation="maskUp" data-appear-animation-delay="350">Our Services</h2>
								</div>
							...
							<div class="col-md-7 col-lg-4 mb-4 mb-lg-0">
								<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-plugin-options="{'accY': -100}">
									...
									<div class="card-body text-center p-5">
										...
										<a href="enterprise-dev-services-detail.html" class="text-color-tertiary font-weight-bold">LEARN MORE +</a>
									</div>
								</div>
				...
				<section class="section section-height-4 position-relative border-0 pt-5 m-0" style="background-color: #fff;">
