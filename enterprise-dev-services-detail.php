										...
										<div class="header-nav-main header-nav-main-square header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle active" href="demo-seo-2-services.html">
															Services
														</a>
					...
					<div class="container pb-2 mb-4">
						<div class="row justify-content-center align-items-center">
							<div class="col-md-10 col-lg-6 mb-5 mb-lg-0">
								<h2 class="text-color-dark font-weight-semibold text-6 line-height-3 mb-0 pr-5 mr-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit.</h2>
								...
								<p class="lead pr-5 mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2000">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur.</p>
							...
							<div class="col-md-10 col-lg-12 mt-4">
								<p class="mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed volutpat nisl a sapien dignissim, at tristique nibh dapibus. Quisque faucibus feugiat libero, ut placerat enim pretium nec. Donec non elit vitae mi pharetra gravida. In eu mauris lectus. Nam blandit suscipit enim id vehicula. Pellentesque commodo convallis neque, viverra lacinia erat feugiat ut. Proin sed ligula egestas, laoreet lorem vitae, vehicula sapien. Mauris facilisis velit eu laoreet aliquet. </p>
								<p class="pb-5 mb-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="350">Praesent finibus pretium scelerisque. Pellentesque sit amet ullamcorper nibh. Quisque et nisi mauris. Nunc eget rutrum massa. Nam eu auctor nisi. Phasellus vestibulum consequat enim. Duis fringilla orci at sem venenatis dignissim. Curabitur sollicitudin libero a diam auctor, sed lobortis nulla venenatis. </p>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="footer-copyright bg-color-quaternary">
					<div class="container py-2">
						...
						<div class="row justify-content-center py-4">
							<div class="col-auto">
								<p class="text-color-light opacity-5 text-3">Porto SEO © Copyright 2020. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
